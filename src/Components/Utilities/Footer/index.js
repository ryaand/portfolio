        ...
        <section className="w-screen flex justify-center items-center border-b border-zinc-400/30">
            <div className="flex justify-between h-full w-full p-14 gap-10 max-w-3xl">
                ...
                <div className="flex gap-3">
                    ...
                    <Link className="opacity-50 hover:opacity-100 transition-all duration-300" href="https://mail.google.com/mail/u/0/#inbox?compose=DmwnWrRpctRWvSnMpJjtFlWCxldFvCHlsbMgBRLZrzHJWLWQtkxKdPNDjZHZbFLcCkPTqDfKSPhg"><Image alt="email" src={Github} width={20}></Image></Link>
                </div>
            </div>
        </section>
    )
